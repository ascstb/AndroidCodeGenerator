package com.example.mytestapp.presentation.navigation

import android.content.Context
import android.content.Intent
import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import com.example.mytestapp.core.Session
import com.example.mytestapp.presentation.MainActivity
import com.example.mytestapp.presentation.splash.SplashActivity
...
class NavigationImpl : Navigation {
    ...
    override fun navigateToNoInternet(fromActivity: AppCompatActivity) {
        ...
        val toActivity = when (fromActivity::class) {
            SplashActivity::class -> MainActivity::class.java
